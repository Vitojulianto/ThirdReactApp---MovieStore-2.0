    ...
    <div className="max-w-xl mx-auto mt-10 p-6 bg-white shadow-xl rounded-lg">
      ...
      <div className="space-y-3 text-lg">
        ...
        <div className='flex justify-end gap-4'>
            ...
            onClick={handleGoBack}>GoBack</Button>
            <Button className='mt-6 px-4 bg-green-500 hover:bg-green-600 text-white py-3 rounded-lg text-lg font-semibold'
            onClick={handleNext}>Confirm</Button>
        </div>
