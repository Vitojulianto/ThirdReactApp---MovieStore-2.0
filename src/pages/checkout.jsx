...
export default function CheckoutPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white text-black rounded-lg shadow-lg mt-10">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="mb-6">
        ...
        <input
          className="w-full border p-2 mb-2 rounded text-black bg-white"
        ...
        <button
          type="submit"
          className="mt-6 w-full bg-pink-500 hover:bg-pink-600 text-white py-3 rounded-lg text-lg font-semibold"
        >
          Confirm Order
        </button>
      </form>
